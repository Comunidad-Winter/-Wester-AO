...
Begin VB.Form frmCharInfo 
   ...
   Begin VB.Image aceptar 
      Height          =   375
      Left            =   4440
      MouseIcon       =   "frmCharInfo.frx":E12C
   ...
   Begin VB.Image rechazar 
      Height          =   375
      Left            =   3120
      MouseIcon       =   "frmCharInfo.frx":E436
      MousePointer    =   99  'Custom
      Top             =   5640
      Width           =   1095
   End
   Begin VB.Image desc 
      Height          =   375
      Left            =   1920
      MouseIcon       =   "frmCharInfo.frx":E740
      MousePointer    =   99  'Custom
      Top             =   5640
      Width           =   975
   End
   Begin VB.Image echar 
      Height          =   375
      Left            =   600
      MouseIcon       =   "frmCharInfo.frx":EA4A
      MousePointer    =   99  'Custom
      Top             =   5640
      Width           =   1095
   End
   Begin VB.Image Image1 
      Height          =   375
      Left            =   120
      MouseIcon       =   "frmCharInfo.frx":ED54
      MousePointer    =   99  'Custom
      Top             =   6240
      Width           =   735
   End
...
Select Case Val(ReadField(14, Rdata, 44))
    ...
    Case 1
        ...
        faccion.Caption = "Faccion: Alianza del Flamius"
    Case 2
        faccion.ForeColor = vbRed
        faccion.Caption = "Faccion: Ejército de Lord Azhimur"
End Select
