...
Begin VB.Form frmOpciones 
   ...
   Begin VB.CommandButton cmdKeys 
      ...
      DisabledPicture =   "frmOpciones.frx":0152
      Height          =   375
      Left            =   2280
      MaskColor       =   &H00008000&
      TabIndex        =   21
   ...
   Begin VB.PictureBox Picture1 
      ...
      Height          =   335
      Left            =   2350
      MouseIcon       =   "frmOpciones.frx":4E43
   ...
   Begin VB.PictureBox PictureSanado 
      ...
      Height          =   335
      Left            =   2350
      MouseIcon       =   "frmOpciones.frx":514D
      MousePointer    =   99  'Custom
      ScaleHeight     =   300
      ScaleWidth      =   300
      TabIndex        =   7
   ...
   Begin VB.PictureBox PictureRecuMana 
      ...
      Height          =   335
      Left            =   840
      MouseIcon       =   "frmOpciones.frx":5457
      MousePointer    =   99  'Custom
      ScaleHeight     =   300
      ScaleWidth      =   300
      TabIndex        =   6
   ...
   Begin VB.PictureBox PictureVestirse 
      ...
      Height          =   335
      Left            =   840
      MouseIcon       =   "frmOpciones.frx":5761
      MousePointer    =   99  'Custom
      ScaleHeight     =   300
      ScaleWidth      =   300
      TabIndex        =   5
   ...
   Begin VB.PictureBox PictureMenosCansado 
      ...
      Height          =   335
      Left            =   2350
      MouseIcon       =   "frmOpciones.frx":5A6B
      MousePointer    =   99  'Custom
      ScaleHeight     =   300
      ScaleWidth      =   300
      TabIndex        =   4
   ...
   Begin VB.PictureBox PictureNoHayNada 
      ...
      Height          =   335
      Left            =   2350
      MouseIcon       =   "frmOpciones.frx":5D75
      MousePointer    =   99  'Custom
      ScaleHeight     =   300
      ScaleWidth      =   300
      TabIndex        =   3
   ...
   Begin VB.PictureBox PictureOcultarse 
      ...
      Height          =   335
      Left            =   840
      MouseIcon       =   "frmOpciones.frx":607F
      MousePointer    =   99  'Custom
      ScaleHeight     =   300
      ScaleWidth      =   300
      TabIndex        =   2
   ...
   Begin VB.PictureBox PictureFxs 
      ...
      Height          =   335
      Left            =   2350
      MouseIcon       =   "frmOpciones.frx":6389
      MousePointer    =   99  'Custom
      ScaleHeight     =   300
      ScaleWidth      =   300
      TabIndex        =   1
   ...
   Begin VB.PictureBox PictureMusica 
      ...
      Height          =   335
      Left            =   840
      MouseIcon       =   "frmOpciones.frx":6693
      MousePointer    =   99  'Custom
      ScaleHeight     =   300
      ScaleWidth      =   300
      TabIndex        =   0
   ...
   Begin VB.Label Label11 
      ...
      Height          =   255
      Left            =   720
      MouseIcon       =   "frmOpciones.frx":699D
      MousePointer    =   99  'Custom
      TabIndex        =   18
      Top             =   3360
      Width           =   1455
   ...
   Begin VB.Image Image1 
      Height          =   375
      Left            =   3840
      MouseIcon       =   "frmOpciones.frx":6CA7
      MousePointer    =   99  'Custom
      Top             =   4080
      Width           =   615
   End
