...
Call AddtoRichTextBox(frmPrincipal.rectxt, UserName & " Bienvenido a WesterAo 2.0.", 255, 253, 208, 2, 1)
Call AddtoRichTextBox(frmPrincipal.rectxt, "Al jugar nuestro servidor estás aceptando todos los términos de nuestro reglamento, publicado en nuestro foro.", 150, 75, 0, 2, 1)
Call AddtoRichTextBox(frmPrincipal.rectxt, "Comandos Utiles: /GM, /HOGAR.", 255, 186, 0, 2, 1)
Call AddtoRichTextBox(frmPrincipal.rectxt, "Con el Comando /AGITE entraras a La sala De agite , Al matar un usuario Se te sumara un punto de canje. CUIDADO Al morir Se te descontaran a ti..", 255, 255, 255, 2, 1)
...
Call InitTileEngine(frmPrincipal.hwnd, frmPrincipal.MainViewShp.Top, frmPrincipal.MainViewShp.Left, 32, 32, 13, 17, 9)
...
MainViewRect.Left = (frmPrincipal.Left / Screen.TwipsPerPixelX) + MainViewLeft + 32 * RenderMod.iImageSize
MainViewRect.Top = (frmPrincipal.Top / Screen.TwipsPerPixelY) + MainViewTop + 32 * RenderMod.iImageSize
...
Do While prgRun
    ...
    End If
        ...
        If GetTickCount - lFrameTimer >= 1000 Then
            ...
            Velocidad = 144 / FramesPerSec
            If FPSFLAG Then frmPrincipal.Caption = "WesterAo" & " V " & App.Major & "." & App.Minor & ""
            frmPrincipal.fpstext.Caption = FramesPerSec
        ...
        End If
            ...
            While (GetTickCount - lFrameTimer) \ 18 < FramesPerSecCounter ' reemplazen el 18 por lo q se les cante  mientras menor sea el numero, mayor seran los FPS  es mejor q usen multiplos de 9.
            Sleep 5
        Wend
