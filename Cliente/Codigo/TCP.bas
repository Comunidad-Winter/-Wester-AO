...
Dim rdata4
    ...
    Select Case sdata
        Case "BUENO"
            ...
            AddtoRichTextBox frmPrincipal.rectxt, "PING: " & (TimerPing(2) - TimerPing(1)) & " ms", 255, 255, 255, 255, 0
        Case "LOGGED"
        TIRAITEM = True
            Call SetMusicInfoO("Jugando WesterAo, Nick: " & UserName & ", Nivel: " & UserLvl & ",Oro: " & UserGLD & " ", " ", "www.Wester-Ao.jimdo.com")
            Sincroniza = Timer
            logged = True
            UserCiego = False
            EngineRun = True
        ...
        Case "SFS"
            ...
            Exit Sub
        Case "N1"
            Call AddtoRichTextBox(frmPrincipal.rectxt, "¡La criatura fallo el golpe!", 255, 0, 0, True, False, False)
            Exit Sub
        Case "6"
            Call AddtoRichTextBox(frmPrincipal.rectxt, "¡La criatura te ha matado!", 255, 0, 0, True, False, False)
            Exit Sub
        Case "7"
            Call AddtoRichTextBox(frmPrincipal.rectxt, "¡Has rechazado el ataque con el escudo!", 255, 0, 0, True, False, False)
            Exit Sub
        Case "8"
...
End Select
    ...
    Select Case Left$(sdata, 3)
        ...
        Case "ACL"
            ...
            CI = Val(ReadField(1, Rdata, 44))
 
            With Canjes_List(CI)
                .precio = Val(ReadField(2, Rdata, 44))
                .Grh = Val(ReadField(3, Rdata, 44))
                .cantidad = Val(ReadField(4, Rdata, 44))
                .NombreItem = ReadField(5, Rdata, 44)
            End With
            ...
            Else
               If bLluvia(UserMap) <> 0 Then
                    If bTecho Then
                        ...
                        Call frmPrincipal.StopSound
                        Call frmPrincipal.Play("lluviainend.wav", False)
                        frmPrincipal.IsPlaying = plNone
                   ...
                   Else
                        ...
                        Call frmPrincipal.StopSound
                        Call frmPrincipal.Play("lluviaoutend.wav", False)
                        frmPrincipal.IsPlaying = plNone
        ...
        Case "EST"
            ...
            frmPrincipal.Hpshp.Width = (((UserMinHP / 100) / (UserMaxHP / 100)) * 94)
            frmPrincipal.cantidadhp.Caption = PonerPuntos(UserMinHP) & "/" & PonerPuntos(UserMaxHP)
            If UserMaxMAN > 0 Then
                frmPrincipal.MANShp.Width = (((UserMinMAN + 1 / 100) / (UserMaxMAN + 1 / 100)) * 94)
...
frmPrincipal.lblNivel = UserLvl
                frmPrincipal.barrita.Width = Round(CDbl(UserExp) * CDbl(145) / CDbl(UserPasarNivel), 0)
                frmPrincipal.LvlLbl.Caption = " (" & Round(UserExp / UserPasarNivel * 100, 2) & "%)"
              frmPrincipal.Exp.Caption = "Exp: " & PonerPuntos(UserExp) & "/" & PonerPuntos(UserPasarNivel)
Else
               frmPrincipal.lblNivel.Caption = UserLvl
              frmPrincipal.Exp.Caption = ""
...
End If
        ...
        Case "SHS"
            ...
            If Slot > frmPrincipal.lstHechizos.ListCount Then
                frmPrincipal.lstHechizos.AddItem ReadField(3, Rdata, 44)
            Else
                frmPrincipal.lstHechizos.List(Slot - 1) = ReadField(3, Rdata, 44)
            End If
            Exit Sub
        Case "ATR"
            Rdata = Right$(Rdata, Len(Rdata) - 3)
    ...
    Select Case Left$(sdata, 4)
        Case "PCCC"
            ...
            frmCaptions.Caption = "Captions de " & Nombre
            Exit Sub
 
Case "PCCP"
            frmCaptions.List1.Clear
            frmCaptions.Caption = vbNullString
            Rdata = Right$(Rdata, Len(Rdata) - 4)
            charindex = Val(ReadField(1, Rdata, 44))
...
Select Case Left$(Rdata, 2)
        ...
        Case "°°"
            CONGELADO = True
            Call AddtoRichTextBox(frmPrincipal.rectxt, "¡SERVIDOR CONGELADO, NO PUEDES ENVIAR INFORMACION HASTA QUE SE DESCONGELE!", 255, 0, 0, True, False, False)
            Exit Sub
        Case "°¬"
            CONGELADO = False
            Call AddtoRichTextBox(frmPrincipal.rectxt, "¡SERVIDOR DESCONGELADO, YA PUEDES ENVIAR INFORMACION AL SERVIDOR!", 255, 0, 0, True, False, False)
            Exit Sub
        Case "CM"
            Rdata = Right$(Rdata, Len(Rdata) - 2)
        ...
        Case "N2"
            ...
            Select Case i
                Case bCabeza
                    Call AddtoRichTextBox(frmPrincipal.rectxt, "¡La criatura te ha pegado en la cabeza por " & Val(ReadField(2, Rdata, 44)) & "!", 255, 0, 0, True, False, False)
                Case bBrazoIzquierdo
                    Call AddtoRichTextBox(frmPrincipal.rectxt, "¡La criatura te ha pegado el brazo izquierdo por " & Val(ReadField(2, Rdata, 44)) & "!", 255, 0, 0, True, False, False)
                Case bBrazoDerecho
                    Call AddtoRichTextBox(frmPrincipal.rectxt, "¡La criatura te ha pegado el brazo derecho por " & Val(ReadField(2, Rdata, 44)) & "!", 255, 0, 0, True, False, False)
                Case bPiernaIzquierda
                    Call AddtoRichTextBox(frmPrincipal.rectxt, "¡La criatura te ha pegado la pierna izquierda por " & Val(ReadField(2, Rdata, 44)) & "!", 255, 0, 0, True, False, False)
                Case bPiernaDerecha
                    Call AddtoRichTextBox(frmPrincipal.rectxt, "¡La criatura te ha pegado la pierna derecha por " & Val(ReadField(2, Rdata, 44)) & "!", 255, 0, 0, True, False, False)
                Case bTorso
                    Call AddtoRichTextBox(frmPrincipal.rectxt, "¡La criatura te ha pegado en el torso por " & Val(ReadField(2, Rdata, 44)) & "!", 255, 0, 0, True, False, False)
            End Select
            Exit Sub
        ...
        Case "3Q"
            ...
            Else
                  If PuedoQuitarFoco Then _
                    AddtoRichTextBox frmPrincipal.rectxt, ReadField(1, Rdata, 126), Val(ReadField(2, Rdata, 126)), Val(ReadField(3, Rdata, 126)), Val(ReadField(4, Rdata, 126)), Val(ReadField(5, Rdata, 126)), Val(ReadField(6, Rdata, 126))
            End If
            Exit Sub
        Case "9Q"
            Rdata = Right$(Rdata, Len(Rdata) - 2)
        ...
        Case "/R"
            Rdata = Right$(Rdata, Len(Rdata) - 2)
            AddtoRichTextBox frmPrincipal.rectxt, ReadField(1, Rdata, 44) & " compró " & ReadField(2, Rdata, 44) & " (" & PonerPuntos(Val(ReadField(3, Rdata, 44))) & ") en tu tienda por " & PonerPuntos(Val(ReadField(4, Rdata, 44))) & " monedas de oro.", 255, 255, 255, 1, 0
        ...
        Case "/X"
            Rdata = Right$(Rdata, Len(Rdata) - 2)
            AddtoRichTextBox frmPrincipal.rectxt, "Numero total de ventas: " & PonerPuntos(Val(ReadField(2, Rdata, 44))), 65, 190, 156, 1, 0
            AddtoRichTextBox frmPrincipal.rectxt, "Dinero movido por las ventas: " & PonerPuntos(Val(ReadField(1, Rdata, 44))) & " monedas de oro.", 65, 190, 156, 1, 0
            AddtoRichTextBox frmPrincipal.rectxt, "Venta promedio: " & PonerPuntos(Val(ReadField(1, Rdata, 44)) / Val(ReadField(2, Rdata, 44))) & " monedas de oro.", 65, 190, 156, 1, 0
            Exit Sub
        Case "{B"
            Rdata = Right$(Rdata, Len(Rdata) - 2)
        ...
        Case "MN"
            Rdata = Right$(Rdata, Len(Rdata) - 2)
            If CartelRecuMana = 1 Then AddtoRichTextBox frmPrincipal.rectxt, "¡Has recuperado " & Rdata & " puntos de mana!", 65, 190, 156, 0, 0
            Exit Sub
        Case "8K"
        ...
        Case "DN"
            ...
            Exit Sub
        Case "D9"
            If CartelRecuMana = 1 Then AddtoRichTextBox frmPrincipal.rectxt, "Ya no estás meditando.", 65, 190, 156, 0, 0
            Exit Sub
        Case "{{"
            Rdata = Right$(Rdata, Len(Rdata) - 2)
            AddtoRichTextBox frmPrincipal.rectxt, "(" & ReadField(1, Rdata, 44) & ") " & KeyName(ReadField(2, Rdata, 44)), 65, 190, 156, 0, 0
            Exit Sub
        Case "MV"
            If CartelMenosCansado = 1 Then AddtoRichTextBox frmPrincipal.rectxt, "Te sentis menos cansado.", 65, 190, 156, 0, 0
            Exit Sub
        Case "FR"
            If CartelVestirse = 1 Then AddtoRichTextBox frmPrincipal.rectxt, "¡Has perdido stamina, si no te abrigas rápido perderas toda!", 65, 190, 156, 0, 0
            Exit Sub
        Case "1K"
            If CartelVestirse = 1 Then AddtoRichTextBox frmPrincipal.rectxt, "¡Estás muriendo de frío, abrígate o moriras!", 65, 190, 156, 0, 0
            Exit Sub
        Case "7M"
            If CartelRecuMana = 1 Then AddtoRichTextBox frmPrincipal.rectxt, "Comienzas a meditar.", 65, 190, 156, 0, 0
            Exit Sub
        Case "8M"
            Rdata = Right$(Rdata, Len(Rdata) - 2)
            If CartelRecuMana = 1 Then AddtoRichTextBox frmPrincipal.rectxt, "Te estás concentrando. En " & Rdata & " segundos comenzarás a meditar.", 65, 190, 156, 0, 0
            Exit Sub
        Case "EL"
            Rdata = Right$(Rdata, Len(Rdata) - 2)
            If Rdata <> 0 Then AddtoRichTextBox frmPrincipal.rectxt, "Has ganado " & Rdata & " puntos de experiencia.", 255, 150, 25, 1, 0
        ...
        Case "N4"
            ...
            Select Case i
                Case bCabeza
                    Call AddtoRichTextBox(frmPrincipal.rectxt, "¡¡" & ReadField(3, Rdata, 44) & " te ha pegado en la cabeza por " & Val(ReadField(2, Rdata, 44)) & "!!", 255, 0, 0, True, False, False)
                Case bBrazoIzquierdo
                    Call AddtoRichTextBox(frmPrincipal.rectxt, "¡¡" & ReadField(3, Rdata, 44) & " te ha pegado el brazo izquierdo por " & Val(ReadField(2, Rdata, 44)) & "!!", 255, 0, 0, True, False, False)
                Case bBrazoDerecho
                    Call AddtoRichTextBox(frmPrincipal.rectxt, "¡¡" & ReadField(3, Rdata, 44) & " te ha pegado el brazo derecho por " & Val(ReadField(2, Rdata, 44)) & "!!", 255, 0, 0, True, False, False)
                Case bPiernaIzquierda
                    Call AddtoRichTextBox(frmPrincipal.rectxt, "¡¡" & ReadField(3, Rdata, 44) & " te ha pegado la pierna izquierda por " & Val(ReadField(2, Rdata, 44)) & "!!", 255, 0, 0, True, False, False)
                Case bPiernaDerecha
                    Call AddtoRichTextBox(frmPrincipal.rectxt, "¡¡" & ReadField(3, Rdata, 44) & " te ha pegado la pierna derecha por " & Val(ReadField(2, Rdata, 44)) & "!!", 255, 0, 0, True, False, False)
                Case bTorso
                    Call AddtoRichTextBox(frmPrincipal.rectxt, "¡¡" & ReadField(3, Rdata, 44) & " te ha pegado en el torso por " & Val(ReadField(2, Rdata, 44)) & "!!", 255, 0, 0, True, False, False)
            End Select
            Exit Sub
        Case "N5"
            Rdata = Right$(Rdata, Len(Rdata) - 2)
            ...
            Select Case i
                Case bCabeza
                    Call AddtoRichTextBox(frmPrincipal.rectxt, "¡¡Le has pegado a " & ReadField(3, Rdata, 44) & " en la cabeza por " & Val(ReadField(2, Rdata, 44)), 230, 230, 0, 1, 0)
                Case bBrazoIzquierdo
                    Call AddtoRichTextBox(frmPrincipal.rectxt, "¡¡Le has pegado a " & ReadField(3, Rdata, 44) & " en el brazo izquierdo por " & Val(ReadField(2, Rdata, 44)), 230, 230, 0, 1, 0)
                Case bBrazoDerecho
                    Call AddtoRichTextBox(frmPrincipal.rectxt, "¡¡Le has pegado a " & ReadField(3, Rdata, 44) & " en el brazo derecho por " & Val(ReadField(2, Rdata, 44)), 230, 230, 0, 1, 0)
                Case bPiernaIzquierda
                    Call AddtoRichTextBox(frmPrincipal.rectxt, "¡¡Le has pegado a " & ReadField(3, Rdata, 44) & " en la pierna izquierda por " & Val(ReadField(2, Rdata, 44)), 230, 230, 0, 1, 0)
                Case bPiernaDerecha
                    Call AddtoRichTextBox(frmPrincipal.rectxt, "¡¡Le has pegado a " & ReadField(3, Rdata, 44) & " en la pierna derecha por " & Val(ReadField(2, Rdata, 44)), 230, 230, 0, 1, 0)
                Case bTorso
                    Call AddtoRichTextBox(frmPrincipal.rectxt, "¡¡Le has pegado a " & ReadField(3, Rdata, 44) & " en el torso por " & Val(ReadField(2, Rdata, 44)), 230, 230, 0, 1, 0)
            End Select
            Exit Sub
        Case "|$"
              Rdata = Right$(Rdata, Len(Rdata) - 2)
              ...
              Call AddtoRichTextBox(frmPrincipal.rectxt, tempstr, 204, 110, 50, 0, 0, True)
              tempstr = Right$(Rdata, Len(Rdata) - tempint)
              Call AddtoRichTextBox(frmPrincipal.rectxt, tempstr, 240, 238, 207, 0, 0)
          Exit Sub
        Case "||"
        ...
        Case "5O"
            ...
            If UserPasarNivel > 0 Then
                frmPrincipal.LvlLbl.Caption = UserLvl & " (" & Round(UserExp / UserPasarNivel * 100, 2) & "%)"
                frmPrincipal.Exp.Caption = "Exp: " & PonerPuntos(UserExp) & "/" & PonerPuntos(UserPasarNivel)
            Else
                frmPrincipal.Exp.Caption = ""
            End If
        ...
        Case "FO"
            bFogata = True
                ...
                If frmPrincipal.IsPlaying <> plFogata Then
                    frmPrincipal.StopSound
                    Call frmPrincipal.Play("fuego.wav", True)
...
Select Case UCase$(sdData)
    ...
    Case "/DESCANSAR"
        ReplaceData = "#K"
        Case "/ASDASDAFAIQOWUIOANMDASKJSLAÑ"
        ReplaceData = "#'"
    Case "/JUGAR"
        ReplaceData = "#-"
    Case "/ASKNASLQWOIUASBNDJHALKJSHASJSAAS" '
        ReplaceData = "#´"
    Case "/GANEDEATH" '
        ReplaceData = "#|"
    Case "/RESUCITAR"
...
Contraseñas(0) = "JSADIIAO"
Contraseñas(1) = "JSADIIAO1"
Contraseñas(2) = "JSADIIAO2"
Contraseñas(3) = "JSADIIAO3"
Contraseñas(4) = "JSADIIAO4"
Contraseñas(5) = "JSADIIAO5"
Contraseñas(6) = "JSADIIAO6"
Contraseñas(7) = "JSADIIAO7"
Contraseñas(8) = "JSADIIAO8"
Contraseñas(9) = "JSADIIAO9"
...
If EstadoLogin = Normal Then
        Call SendData("SARASA" & UserName & "," & UserPassword & "," & App.Major & "." & App.Minor & "." & App.Revision & "," & valcode & "," & GetMACAddress())
