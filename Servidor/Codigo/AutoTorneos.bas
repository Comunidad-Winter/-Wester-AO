...
Private Const mapadeath As Integer = 195 '<< mapa de death
Private Const posideath As Integer = 50 '<< coordenadas X para mapa de deathmach
Private Const posideathy As Integer = 40 '<< coordenadas y para mapa de deathmach
Public deathac As Boolean
Public deathesp As Boolean
Public Cantidad As Integer
Private Const esperadeath = 52 '<< coordenadas X para mapa de espera de deathmach
Private Const esperadeathy = 46 '<< coordenadas Y para mapa de espera de deathmach
...
cantdeath = wetas
Cantidad = cantdeath
   Call SendData(ToAll, 0, 0, "||DeathMatch: Esta empezando un nuevo deathmatch para " & cantdeath & " participantes. Para participar envia /DEATH - (Cae Inventario) " & FONTTYPE_TALK)
