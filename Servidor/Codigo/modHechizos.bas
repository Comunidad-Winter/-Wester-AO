...
Call SendData(ToIndex, UserIndex, 0, "||No puedes usar Inmovilizar en este mapa" & FONTTYPE_FENIX)
End If
Exit Sub
End If
...
If UserList(UserIndex).pos.Map = 190 And UserList(UserIndex).Clase = MAGO Then
Call SendData(ToIndex, UserIndex, 0, "||No puedes usar Inmovilizar en este mapa" & FONTTYPE_FENIX)
Exit Sub
End If
...
If UserList(UserIndex).pos.Map = 190 Or UserList(UserIndex).pos.Map = 210 Or UserList(UserIndex).pos.Map = 199 Or UserList(UserIndex).pos.Map = 192 Or UserList(UserIndex).pos.Map = 194 Or UserList(UserIndex).pos.Map = 195 Or UserList(UserIndex).pos.Map = 197 Or UserList(UserIndex).pos.Map = 196 Or UserList(UserIndex).pos.Map = 200 Then
Call SendData(ToIndex, UserIndex, 0, "||No puedes hacerte invisible en este mapa" & FONTTYPE_FENIX)
Exit Sub
End If
