...
Public ParticipanteDeath(1 To 6) As Integer
Public PuedeDeath As Boolean '
Public HayDeath As Boolean
...
'###### GUERRACLAN by GALLE ######
Public CLAN1 As Integer
Public CLAN2 As Integer
...
'###### GUERRACLAN by GALLE######
Public Macsbaneadas As String
Public Actretos As Boolean
Public Puesto As Byte
Public TransFacc As Boolean
...
Public MurioDeath As Integer
Public CantidadDeath As Integer
Public CostoDeath As Long
Public Restando As Integer
Public CupoMaximo As Integer
Public seacabodeath As Boolean
Public hyunpt As Integer
...
Public Const NPCTYPE_MISION = 12
...
Public Const MapaRetoPJ = 213
Public Const MapaRetoX1 = 11
Public Const MapaRetoY1 = 15
Public Const MapaRetoX2 = 30
Public Const MapaRetoY2 = 72

Type UserFlags
EstaMision As Integer
death As Boolean
         EnDeath As Integer
    Esperando As Boolean
Desafiando As Boolean
Retando As Boolean 'retos adaptados
    EsperandoReto As Boolean 'de lekasak
    VIP As Byte ' simp
...
Public BanMACs As New Collection
